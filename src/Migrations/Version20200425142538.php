 ...
 */
final class Version20200425142538 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, theme_id INT NOT NULL, name VARCHAR(255) NOT NULL, display_order INT NOT NULL, thumbnail_path VARCHAR(255) DEFAULT NULL, INDEX IDX_64C19C159027487 (theme_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE consumable (id INT AUTO_INCREMENT NOT NULL, tool_id INT NOT NULL, name VARCHAR(255) NOT NULL, picture_path VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, charge LONGTEXT NOT NULL, INDEX IDX_4475F0958F7B22CC (tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, tool_id INT NOT NULL, answer LONGTEXT NOT NULL, INDEX IDX_B6F7494E8F7B22CC (tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tip (id INT AUTO_INCREMENT NOT NULL, tool_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, picture_path VARCHAR(255) DEFAULT NULL, youtube_link VARCHAR(255) DEFAULT NULL, INDEX IDX_4883B84C8F7B22CC (tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tool (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, picture_path VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, display_order INT NOT NULL, informations LONGTEXT DEFAULT NULL, information_picture_path VARCHAR(255) DEFAULT NULL, INDEX IDX_20F33ED112469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
