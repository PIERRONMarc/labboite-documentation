 ...
 */
final class Version20200606020617 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE consumable (id INT AUTO_INCREMENT NOT NULL, tool_id INT NOT NULL, name VARCHAR(255) NOT NULL, picture_name VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, price VARCHAR(255) DEFAULT NULL, charge LONGTEXT DEFAULT NULL, INDEX IDX_4475F0958F7B22CC (tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, tool_id INT NOT NULL, name VARCHAR(255) NOT NULL, link VARCHAR(255) NOT NULL, INDEX IDX_BC91F4168F7B22CC (tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tool (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, notice_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, picture_name VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, display_order INT NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_20F33ED112469DE2 (category_id), UNIQUE INDEX UNIQ_20F33ED17D540AB (notice_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
